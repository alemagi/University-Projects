...
As an example, consider station $101$ between San Francisco and Los Angeles. Notice that the suggested limit of $\text{PM}_{2.5}$ is given by $25$ micrograms per cubic meter (average over $24$ hours).

```{r, message= F, warning= F, out.width = '70%', fig.align = "center"}
plotdata <- dat %>% dplyr::filter(station_id == 101)

plotdata %>% 
  ggplot() + 
  ggtitle("PM2.5 levels at Station #101") +
...
Thus, to get started, you should choose a station (to be chosen among the ones with id 47, 55, 92, 95, 97 and 103) and
